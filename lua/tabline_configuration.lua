-- Taken from https://github.com/alvarosevilla95/luatab.nvim/blob/master/lua/luatab/init.lua
...
M.title = function(bufnr)
    ...
    elseif buftype == 'terminal' then
        ...
        return 'T:'..(mtch ~= nil and mtch or vim.fn.fnamemodify(vim.env.SHELL, ':t'))
    elseif file == '' then
        return '[No Name]'
    else
...
local setup = function(opts)
    ...
    vim.opt.tabline = '%!v:lua.require\'tabline_configuration\'.helpers.tabline()'
end
